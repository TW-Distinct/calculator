...
//主类
public class Chess extends JFrame implements ActionListener,MouseListener,Runnable{
	...
	*/
	...
	public Chess() {
		super();
		setTitle("轻松一刻——中国象棋：观棋不语真君子，棋死无悔大丈夫");	
		...
		JMenuBar mb = new JMenuBar();//创建菜单栏
 		...
 		JMenuItem c2 = new JMenuItem("简易版专注神器");
