...
class JMine extends JFrame implements MouseListener, ActionListener {
	...
	private ImageIcon [] mineNumIcon = { new ImageIcon("image\\0.gif"), new ImageIcon("image\\1.gif"),
					     new ImageIcon("image\\2.gif"), new ImageIcon("image\\3.gif"),
					     new ImageIcon("image\\4.gif"), new ImageIcon("image\\5.gif"),
					     new ImageIcon("image\\6.gif"), new ImageIcon("image\\7.gif"),
					     new ImageIcon("image\\8.gif"), new ImageIcon("image\\9.gif"),
					};
	private ImageIcon[] mineStatus = { new ImageIcon("image\\0.gif"), new ImageIcon("image\\flag.gif"), 
						new ImageIcon("image\\question.gif") };
	private ImageIcon[] mineBombStatus = { new ImageIcon("image\\0.gif"), new ImageIcon("image\\mine.gif"), 
						new ImageIcon("image\\wrongmine.gif"), new ImageIcon("image\\bomb.gif") };
	private ImageIcon[] faceIcon = { new ImageIcon("image\\smile.gif"), new ImageIcon("imageOoo.gif")};
	...
	public JMine() {
		...
		mOther=new JMenu("其他菜单");
		back=new JMenuItem("主页");
		back.addActionListener(new MenuItemListener());
		focus=new JMenuItem("简易版专注神器");
		focus.addActionListener(new MenuItemListener());
		xiangqi=new JMenuItem("轻松一刻——中国象棋");
		xiangqi.addActionListener(new MenuItemListener());
		mOther.add(back);
		mOther.add(focus);
		mOther.add(xiangqi);
		mb.add(mOther);
